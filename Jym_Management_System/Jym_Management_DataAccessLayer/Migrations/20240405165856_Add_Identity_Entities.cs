    ...
    public partial class Add_Identity_Entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_tbSubscriptionPayments_tbUsers",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbPermssions", x => x.ID);
                    table.ForeignKey(
                        name: "FK_permissions",
                        column: x => x.RoleID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "tbPermssions",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_tbUsers_tbPerson",
                        column: x => x.PersonId,
                        principalTable: "tbPerson",
                        principalColumn: "PersonID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbPermssions_RoleID",
                table: "tbPermssions",
                column: "RoleID");

            migrationBuilder.CreateIndex(
                name: "IX_tbUsers_permissionsID",
                table: "tbUsers",
                column: "permissionsID");

            migrationBuilder.CreateIndex(
                name: "IX_tbUsers_PersonId",
                table: "tbUsers",
                column: "PersonId");
